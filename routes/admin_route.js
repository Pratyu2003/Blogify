...
admin_route.get('/settings', admin_login_auth.is_login, admin_controller.load_Settings);
admin_route.post('/settings', admin_login_auth.is_login, admin_controller.save_Settings);
